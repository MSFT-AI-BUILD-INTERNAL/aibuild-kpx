...
- **0 errors / 0 safety violations / 99.3% idempotent / 평균 21.36% 토큰 절감** 으로 production-ready.
...
- v0.2.0의 +21.36% 주장이 **완전히 다른 코퍼스**(실세계 코딩 프롬프트)에서 +20.95%로 독립 재현됨
